...
namespace Lift_Project
{
    internal class Lift
    {
        ...
        public Lift(PictureBox mainElevator, Button btn_1, Button btn_G, int formSize, int liftSpeed, Timer liftTimerUp, Timer liftTimerDown, PictureBox ffloorback, PictureBox gFloorBack, Timer doorTimer)
        {
